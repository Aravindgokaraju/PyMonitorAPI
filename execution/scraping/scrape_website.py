...
# from execution.scraping.interruption_handler import InterruptionHandler
...
#     # def _configure_for_worker(self):
#     #     """Configure for Render worker environment"""
#     #     # Set appropriate Chrome options for headless environment
#     #     os.environ['CHROME_BIN'] = '/usr/bin/google-chrome-stable'
        
#     #     # Reduce memory usage for worker environment
#     #     self.max_concurrent_tabs = 2  # Limit concurrent tabs
#     #     self.timeout = 300  # 5 minute timeout per page
